...
export default function Sidebar() {
    return (
        <div className="bg-[#212121] w-1/6 hidden md:flex md:flex-col py-4 items-center space-y-4">
            ...
            <span className="uppercase tracking-widest text-gray-400 opacity-80 text-sm pt-6 w-2/3">Functional Roles</span>
            <span className="uppercase tracking-widest text-gray-400 opacity-80 text-sm pt-6 w-2/3">Premium</span>
            ...
            <span className="uppercase tracking-widest text-gray-400 opacity-80 text-sm pt-6 w-2/3">Miscellanous</span>

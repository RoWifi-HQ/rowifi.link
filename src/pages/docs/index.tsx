        ...
        <DocsLayout>
            ...
            >
                <div className="inline-flex mx-auto items-center bg-[#212121] hover:bg-hover-dark rounded-lg space-x-3 pl-4 pr-6 cursor-pointer">
                    ...
                    <span className="text-white">Power up your server today for free</span>
            ...
            <div className="py-2 flex flex-col">
                ...
                <span className="text-gray-400 opacity-80 text-sm mt-2">{changelogDate("2021-09-12")}</span>
                ...
                <table className="!text-center">
                    ...
                    <tbody>
                        ...
                        <tr className="!border-b-0">
                            ...
                            <td><CheckIcon className="text-green-600 h-6 w-6 block mx-auto" /></td>
                            <td><CheckIcon className="text-green-600 h-6 w-6 block mx-auto" /></td>
                            <td><CheckIcon className="text-green-600 h-6 w-6block mx-auto" /></td>
                        </tr>
                        <tr className="!border-b-0">
                            <td>Custombinds</td>
                            <td><CheckIcon className="text-green-600 h-6 w-6 block mx-auto" /></td>

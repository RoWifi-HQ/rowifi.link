    ...
    <div className="flex flex-col font-inter text-white">
      ...
      <main className="px-1">
        <div className="flex flex-col py-20 max-w-4xl mx-auto space-y-5">
          <span className="md:text-8xl text-4xl text-center font-extrabold bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-transparent bg-clip-text">
            The 2nd Gen
          </span>
          <span className="md:text-8xl text-4xl text-center font-extrabold">
            Roblox-Discord
          </span>
          <span className="md:text-8xl text-4xl text-center font-extrabold">
            Verification Bot
          ...
          <div className="py-12 mx-auto flex flex-col md:flex-row md:space-x-10  space-y-4 md:space-y-0">
            ...
            <Link to="/docs">
              <div className="bg-transparent border border-gray-600 text-gray-500 inline-flex items-center px-8 py-3 rounded-md hover:text-white hover:border-white">
                Learn More
        ...
        <section className="flex flex-col">
          <span id="features" className="mx-auto md:text-6xl text-3xl">
            Features
          </span>
          <FadeIn>
            <div className="py-24 flex md:flex-row flex-col w-full text-center md:text-left justify-evenly">
              <div className="my-auto flex flex-col max-w-md mx-auto md:mx-0">
                <span className="text-2xl font-bold">
                  Highly Customizable Bind System
                </span>
                <span className="mt-4 text-gray-300 leading-tight">
                  Create integrations between Roblox groups & Discord servers
                  with our powerful bind engine. You can even use our Lua-like
                  language to mix and match different bind types.
                </span>
              </div>
              <div>
                <Image
          ...
          <FadeIn>
            <div className="py-24 flex flex-col w-full text-center md:text-left justify-evenly md:flex-row-reverse">
              <div className="my-auto flex flex-col max-w-md mx-auto md:mx-0">
                ...
                <span className="mt-4 text-gray-300 leading-tight">
                  Switch seamlessly between any Roblox accounts you own. No need
                  to worry about having only one account across all Discord
                  servers you are a part of.
                </span>
              </div>
              <div>
                <Image
          ...
          <FadeIn>
            <div className="py-24 flex md:flex-row flex-col w-full text-center md:text-left justify-evenly">
              <div className="my-auto flex flex-col max-w-md mx-auto md:mx-0">
                <span className="text-2xl font-bold">
                  Smart Functional Roles
                </span>
                <span className="mt-4 text-gray-300 leading-tight">
                  We understand you are wary about giving management permissions
                  to members in your community. Create the named roles we
                  support and let your members have these roles. Leave the worry
                  to us!
                </span>
              </div>
              <div>
        ...
        <section className="bg-dashboard-dark flex py-6 flex-col">
          <span className="md:text-3xl text-xl text-center lg:text-left mx-auto">
            The Best Roblox Bot for Discord with even more systems
          </span>
        ...
        <section className="flex flex-wrap justify-evenly py-24 space-y-8 md:space-y-0">
          <div className="flex flex-col items-center max-w-xs space-y-4">
            ...
            <span className="text-sm text-center text-gray-300">
              View how your Roblox group has been growing & meeting milestones
              on beautiful graphs.
            </span>
          </div>
          <div className="flex flex-col items-center max-w-xs space-y-4">
            ...
            <span className="text-sm text-center text-gray-300">
              Keep your server safe by denying access to certain users or
              certain groups.
            </span>
          </div>
          <div className="flex flex-col items-center max-w-xs space-y-4">
            ...
            <span className="text-sm text-center text-gray-300">
              Track what & how many events your members have been hosting.
            </span>
          </div>
          <div className="flex flex-col items-center max-w-xs space-y-4">
            ...
            <span className="text-sm text-center text-gray-300">
              Create a backup of all your binds & server configuration and
              restore it in any server you own.
            </span>
          </div>
        </section>
      </main>

...
import algolia1 from "@docsearch/css/dist/_variables.css";
import algolia2 from "@docsearch/css/dist/button.css";
import algolia3 from "@docsearch/css/dist/modal.css";
import algolia4 from "@docsearch/css/dist/style.css";

export const links: LinksFunction = () => {
  return [
    { rel: "stylesheet", href: algolia1 },
    { rel: "stylesheet", href: algolia2 },
    { rel: "stylesheet", href: algolia3 },
    { rel: "stylesheet", href: algolia4 },
  ];
};
      ...
      <header className="flex fixed top-0 inset-x-0 h-16 w-full z-10 items-center py-2 bg-dashboard-dark">
        ...
        <div className="w-full flex md:justify-around px-2 md:px-0">
          ...
          <Link to="/" className="flex items-center">
            ...
            <span className="text-xl ml-2 font-semibold">RoWifi</span>
            <span className="uppercase tracking-widest text-xs ml-3 text-blue-600 bg-blue-600 bg-opacity-40 px-2 py-1 rounded-lg md:block hidden">
              Docs
            </span>
          </Link>
          ...
          <div className="flex items-center space-x-8 text-gray-300 ml-auto md:ml-0 mr-2 md:mr-0">
            <button
              disabled
              className="bg-button-dark px-4 py-1.5 rounded-xl hover:bg-hover-dark cursor-not-allowed inline-flex items-center"
            >
              Dashboard
